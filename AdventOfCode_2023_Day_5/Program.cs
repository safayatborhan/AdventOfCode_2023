...
public class Progam
{
    public static void Main(string[] args)
    {
        ...
        var result = GetMinimumLocation(input);
    ...
    private static List<long> GetSourceDestinationSetSlower(List<List<long>> mappingSet, List<long> sourceValues)
    {
        var destinationValues = new List<long>();
        
        try
        {
            var sourceDestinationSet = new Dictionary<long, long>();
            mappingSet.ForEach(m =>
            {
                sourceDestinationSet.Add(m[1], m[0]);
            ...
            {
                if (sourceDestinationSet.ContainsKey(sourceValue))
                {
                    destinationValues.Add(sourceDestinationSet[sourceValue]);
                }
                else
                {
    ...
    private static (List<long> seeds, Dictionary<string, List<List<long>>> mappingSets) GetMappingDictionary(string input)
    {
        ...
        var mappingSourceDestinationSet = new Dictionary<string, List<List<long>>>();
